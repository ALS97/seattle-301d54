...
function displayPics(){
  ...
  // Line 38 throws an error because the variable 'rando' is only defined in a specific code block rather than being global.
  // The program is attempting to utilize a variable it doesn't have access to outside of that block.
...
function showList() {
  for(let i = 0; i < allProducts.length; i++) {
    ...
    liEl.textContent = `${allProducts[i].name} has ${allProducts[i].votes} votes ${allProducts[i].views} views`;
