...
// The 'this' bubbles up a layer and re-renders the studen contruction.
// 2. What is "this" when joe.scopeArrow() is invoked?
// The 'this' bubbles up past the next arrow function above it and refers to th entire window.
// 3. Explain why "this" is different when an arrow function is used.
// When an arrow function is searching for a 'this' and does not find one, it refers to the code block in which it is contained.
